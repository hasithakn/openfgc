...
CREATE TABLE IF NOT EXISTS GRIEVANCE (
  ...
  UNIQUE KEY uk_grievance_reference_id (ORG_ID, REFERENCE_ID),
  INDEX idx_grievance_org_user (ORG_ID, USER_ID),
  INDEX idx_grievance_org_status (ORG_ID, STATUS)
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS GRIEVANCE_TIMELINE_ENTRY (
  ...
  INDEX idx_timeline_grievance_created (ORG_ID, GRIEVANCE_ID, CREATED_TIME),
...
CREATE TABLE IF NOT EXISTS GRIEVANCE_ATTACHMENT (
  ...
  INDEX idx_attachment_grievance_id (GRIEVANCE_ID),
  INDEX idx_attachment_timeline_entry_id (TIMELINE_ENTRY_ID),
